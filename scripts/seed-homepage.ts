...
// 🚨 IMPORTANTE: aquí usamos directamente el contenido base.
// Es el mismo que tienes en restaurantConfig, pero solo lo ponemos 1 vez aquí
...
async function seedHomePage() {
  ...
  await client.createOrReplace({
    _id: 'homePage-default', // siempre la misma home
    _type: 'homePage',
    heroTitle: restaurantConfig.name,
    heroSubtitle: restaurantConfig.tagline,
  });

  console.log('✅ HomePage creada/actualizada en Sanity desde restaurantConfig');
}
